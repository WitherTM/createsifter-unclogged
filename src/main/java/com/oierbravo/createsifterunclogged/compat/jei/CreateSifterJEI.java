package com.oierbravo.createsifterunclogged.compat.jei;
...
import com.oierbravo.createsifterunclogged.compat.jei.category.SiftingCategory;
...
public class CreateSifterJEI implements IModPlugin {
    ...
    private static final ResourceLocation ID = CreateSifterUnclogged.asResource("jei_plugin");
    ...
    private class CategoryBuilder<T extends Recipe<?>> {
        ...
        public CreateRecipeCategory<T> build(String name, CreateRecipeCategory.Factory<T> factory) {
            ...
            CreateRecipeCategory.Info<T> info = new CreateRecipeCategory.Info<>(
                    new mezz.jei.api.recipe.RecipeType<>(CreateSifterUnclogged.asResource(name), recipeClass),
