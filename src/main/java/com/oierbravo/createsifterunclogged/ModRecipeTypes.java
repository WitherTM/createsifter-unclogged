...
import com.oierbravo.createsifterunclogged.content.contraptions.components.sifter.SiftingRecipe;
import com.oierbravo.createsifterunclogged.content.contraptions.components.sifter.SiftingRecipeSerializer;
import com.oierbravo.createsifterunclogged.foundation.data.recipe.SiftingRecipeBuilder;
...
public enum ModRecipeTypes implements IRecipeTypeInfo {
    ...
    ModRecipeTypes(Supplier<RecipeSerializer<?>> serializerSupplier, Supplier<RecipeType<?>> typeSupplier, boolean registerType) {
        ...
        id = CreateSifterUnclogged.asResource(name);
    ...
    private static class Registers {
        private static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, CreateSifterUnclogged.MODID);
        private static final DeferredRegister<RecipeType<?>> TYPE_REGISTER = DeferredRegister.create(Registries.RECIPE_TYPE, CreateSifterUnclogged.MODID);
    }
