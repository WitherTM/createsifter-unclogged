...
import static com.oierbravo.createsifterunclogged.register.ModTags.NameSpace.MOD;
...
public class ModTags {
    ...
    public enum NameSpace {
        ...
        MOD(CreateSifterUnclogged.MODID, false, true),CREATE(Create.ID, true, false), FORGE("forge");
